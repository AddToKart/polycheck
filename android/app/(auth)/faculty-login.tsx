      ...
      <KeyboardAvoidingView style={styles.flex1} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          <View style={[styles.card, isDark && styles.cardDark]}>
            <Text style={[styles.heading, isDark && styles.textWhite]}>Faculty Access</Text>
            <Text style={[styles.subHeading, isDark && styles.textWhite50]}>Authenticate to continue</Text>

            <Text style={[styles.label, isDark && styles.textWhite50]}>Email Address</Text>
            <View style={[styles.inputRow, isDark && styles.inputRowDark]}>
              <MaterialIcons name="mail" size={20} color="#888" />
              <TextInput
            ...
            <Text style={[styles.demo, isDark && styles.textWhite50]}>
              Demo: Use jmdelacruz@pup.edu.ph
            </Text>
            ...
            >
              <Text style={styles.submitText}>{loading ? 'Verifying...' : 'Sign In'}</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
...
const styles = StyleSheet.create({
  ...
  iconBtnDark: { borderColor: '#3F3F46', backgroundColor: '#18181B' },
  card: {
    width: '100%', maxWidth: 384, alignSelf: 'center',
    borderWidth: 2, borderColor: '#D4D4D8', backgroundColor: '#FFFFFF',
    padding: 32,
  },
  cardDark: { borderColor: '#3F3F46', backgroundColor: '#18181B' },
