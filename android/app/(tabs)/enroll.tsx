...
export default function EnrollScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-campus dark:bg-campus-dark" testID="student-enroll-screen">
      <CampusHeader
          ...
          <View className="flex-1 px-4 pb-8 pt-2">
            <CampusCard className="p-6">
              <View className="mb-6 h-14 w-14 items-center justify-center rounded-[20px] bg-maroon/5 dark:bg-golden/10">
                <MaterialIcons name="vpn-key" size={25} color={isDark ? pupColors.golden : pupColors.maroon} />
              </View>
              ...
              <CampusButton label={loading ? 'Checking code…' : 'Add class'} icon="add" onPress={handleEnroll} disabled={loading} testID="enrollment-submit" />
            </CampusCard>
          </View>
        </ScrollView>
